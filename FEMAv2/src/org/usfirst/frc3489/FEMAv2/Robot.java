...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        SmartDashboard.putData(autonomousSelection);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addObject("autoChooser", new autoChooser());
    ...
    public void disabledInit(){
    	Robot.driveSystem.resetClimber();
    	endGame = false;
    }
    ...
    public void teleopPeriodic() {
    	SmartDashboard.putNumber("Current Heading", Robot.driveSystem.getHeading());
        Scheduler.getInstance().run();

...
public class DriveSystem extends Subsystem implements PIDOutput {
    ...
    public void periodic() {
    	...
    	if (m_turnMode) {
    		double leftSpeedValue = rotateToAngleRate;
    		double rightSpeedValue = rotateToAngleRate;
    		
    		differentialDrive.tankDrive(leftSpeedValue, rightSpeedValue);
    	} else if (m_headingLockMode) {
    		double leftSpeedValue = m_straightSpeed + rotateToAngleRate;
    		double rightSpeedValue = m_straightSpeed - rotateToAngleRate;
    ...
    public void driveStraight(double speed) {
    	...
    	if (!this.turnController.isEnabled() ) {
    		this.turnController.setSetpoint(navx.getYaw());
    		this.turnController.enable();
    	}
    }

...
public class OI {
    ...
    public JoystickButton engageDriveTrain;
    ...
    public OI() {
        ...
        manipulatorJoystick = new Joystick(3);
        
        rightJoystick = new Joystick(2);
        
        leftJoystick = new Joystick(1);
        
        engageDriveTrain = new JoystickButton(leftJoystick, 2);
        engageDriveTrain.whileHeld(new AutonomousCommand());

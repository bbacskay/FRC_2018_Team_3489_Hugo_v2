...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("centerAutoR", new centerAutoR());
        ...
        SmartDashboard.putData("centerAutoL", new centerAutoL());
        SmartDashboard.putData("autoDecision", new autoDecision());
